var productNameInput = document.getElementById("productNameInput"); // return element kolo input kolo
var productPriceInput = document.getElementById("productPriceInput"); // return element kolo input kolo
var productCategoryInput = document.getElementById("productCategoryInput"); // return element kolo input kolo
var productDescriptionInput = document.getElementById(
  "productDescriptionInput"
); // return element kolo input kolo
...
function search() {
  var term = searchInput.value; // Corrected toLowerCase method
